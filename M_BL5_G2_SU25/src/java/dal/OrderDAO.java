	...
	public boolean createOrder(Order order) {
		...
		try {
			...
			for (OrderDetail detail : order.getOrderDetails()) {
				...
				if (detail.getDiscount() != null) psDetail.setDouble(6, detail.getDiscount()); else psDetail.setNull(6, Types.FLOAT);
				if (detail.getTaxRate() != null) psDetail.setDouble(7, detail.getTaxRate()); else psDetail.setNull(7, Types.FLOAT);
	...
	public boolean updateOrder(Order order) {
		...
		try {
			...
			for (OrderDetail detail : order.getOrderDetails()) {
				...
				if (detail.getDiscount() != null) psInsertDetail.setDouble(6, detail.getDiscount()); else psInsertDetail.setNull(6, Types.FLOAT);
				if (detail.getTaxRate() != null) psInsertDetail.setDouble(7, detail.getTaxRate()); else psInsertDetail.setNull(7, Types.FLOAT);
