...
/**
 * DBContext class for managing SQL Server database connections. Project:
 * SWP391_M_BL5_G2_SU25
 */
public class DBContext {

    private static final String SERVER_NAME = "localhost";
    private static final String DB_NAME = "SWP391_M_BL5_G2_SU25v1";
     ...
     */
    public static void closeConnection(AutoCloseable ac) {
        if (ac != null) {
            try {
                ac.close();
            } catch (Exception e) {
