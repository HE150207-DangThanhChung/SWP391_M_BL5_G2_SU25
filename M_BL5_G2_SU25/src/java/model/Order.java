...
public class Order {
    ...
    public Employee getSaleBy() {
        return saleBy;
    }

    public void setSaleBy(Employee saleBy) {
        this.saleBy = saleBy;
    }
    ...
    public String toString() {
        return "Order{" + "orderId=" + orderId + ", orderDate=" + orderDate + ", status=" + status + ", customer=" + customer + ", createdBy=" + createdBy + ", saleBy=" + saleBy + ", store=" + store + ", orderDetails=" + orderDetails + '}';
    }
