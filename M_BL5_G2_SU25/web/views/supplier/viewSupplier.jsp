<%-- 
    ...
    Created on : Aug 16, 2025, 10:30:00 AM
    Author     : tayho
--%>
                ...
                <main class="content flex-1 p-6 bg-gray-50">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between">
                            <div>
                                <h1 class="text-3xl font-bold text-gray-900">Chi tiết nhà cung cấp</h1>
                                <p class="text-gray-600 mt-1">Thông tin đầy đủ của nhà cung cấp</p>
                            </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden p-6">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div class="lg:col-span-2">
                                    ...
                                    <p class="px-4 py-3 border border-gray-300 rounded-lg bg-gray-50">${s.supplierName}</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Số điện thoại</label>
                                    <p class="px-4 py-3 border border-gray-300 rounded-lg bg-gray-50">${s.phone}</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                                    <p class="px-4 py-3 border border-gray-300 rounded-lg bg-gray-50">${s.email}</p>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Mã thuế</label>
                                    <p class="px-4 py-3 border border-gray-300 rounded-lg bg-gray-50">${s.taxCode}</p>
                                </div>
