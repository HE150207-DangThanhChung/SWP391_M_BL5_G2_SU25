            ...
            <div class="main-panel flex flex-col min-h-screen">
                ...
                <main class="content flex-1 p-6">
                    ...
                    <div class="mb-6 flex items-center justify-between">
                        ...
                        <a href="${pageContext.request.contextPath}/management/categories/add"
                    ...
                    <!-- Search & Filter -->
                    <form method="get" action="${pageContext.request.contextPath}/management/categories" class="flex items-center gap-3 mb-4">
                                        ...
                                        <tr>
                                            <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="text-xs text-gray-400 mt-1">Add your first category to get started</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:otherwise>
